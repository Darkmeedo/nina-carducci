class MauGallery {
    ...
    init() {
        ...
        setTimeout(() => { this.gallery.style.opacity = 1; }, 500);
    }
    ...
    prevImage() {
        ...
        this.lightbox.querySelector(".lightboxImage").src = images[prevIndex].src;
    }
    ...
    nextImage() {
        ...
        this.lightbox.querySelector(".lightboxImage").src = images[nextIndex].src;
    }
